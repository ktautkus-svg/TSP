...
describe('compact daily Excel UI', () => {
  ...
  it('lets the driver drop whole regions and edit the schedule inline', () => {
    ...
    expect(importScreen).toContain('testID="region-select-all"');
    expect(importScreen).toContain('testID="region-clear"');
    expect(importScreen).toContain('testID="region-remaining-count"');
    expect(importScreen).toContain('EXCEL_UNASSIGNED_ROUTE_CODE');
    expect(importScreen).toContain('Be regiono');
    expect(importScreen).toContain('mergeImportResult');
  ...
  it('keeps a confirmed route planned until the driver explicitly starts loading', () => {
    ...
    expect(loadingScreen).toContain('testID="defer-planned-route"');
    expect(loadingScreen).toContain('testID="edit-planned-route"');
    expect(loadingScreen).toContain('testID="cancel-planned-route"');
    expect(loadingScreen).toContain('testID="defer-loaded-route"');
    expect(loadingScreen).toContain('testID="open-start-odometer"');
    expect(loadingScreen).not.toContain('odometerPrompted');
