...
const styles = StyleSheet.create({
  ...
  markAllButton: { minHeight: 52, borderRadius: 14, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center', paddingHorizontal: spacing.md },
  markAllText: { color: '#fff', fontSize: 16, fontWeight: '800', textAlign: 'center' },
  allLoadedState: { minHeight: 52, borderRadius: 14, borderWidth: 1, borderColor: colors.primary, backgroundColor: colors.primarySoft, alignItems: 'center', justifyContent: 'center', paddingHorizontal: spacing.md },
  allLoadedText: { color: colors.primary, fontSize: 16, fontWeight: '800', textAlign: 'center' },
  ...
  loadedCard: { borderColor: colors.primary, backgroundColor: colors.primarySoft },
  ...
  address: { color: colors.text, fontSize: 16, fontWeight: '800' },
  weight: { color: colors.text, fontSize: 16, fontWeight: '700' },
  eta: { color: colors.primary, fontSize: 16, fontWeight: '800' },
  ...
  loadButton: { minHeight: 48, marginTop: spacing.sm, borderRadius: 13, backgroundColor: colors.primary, alignItems: 'center', justifyContent: 'center' },
  loadedButton: { opacity: 0.65 },
  loadButtonText: { color: '#fff', fontWeight: '800' },
  reverseButton: { minHeight: 46, borderRadius: 12, borderWidth: 1, borderColor: colors.primary, alignItems: 'center', justifyContent: 'center' },
  reverseText: { color: colors.primary, fontWeight: '800' },
  ...
  odometerCard: { gap: spacing.sm, padding: spacing.md, borderRadius: 16, borderWidth: 1, borderColor: colors.primary, backgroundColor: colors.surface },
  ...
  secondaryButton: { minHeight: 48, borderRadius: 12, borderWidth: 1, borderColor: colors.primary, alignItems: 'center', justifyContent: 'center' },
